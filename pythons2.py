...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'VOTRE_CLE_SECRETE'  # À adapter en production
...
app.config['SWAGGER'] = {
    ...
    # (Optionnel) Pour spécifier qu'on utilise par défaut la sécurité "Bearer" sur tous les endpoints
    'security': [
        {
            'Bearer': []
        }
...
PRODUCTS_FILE = 'products.json'   # Fichier pour la ressource "products"
